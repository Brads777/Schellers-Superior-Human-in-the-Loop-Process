...
## High Priority
- [ ] Design spec (brainstorming session) — full architecture, interfaces, rubric format
- [ ] Build interview engine skill — intent gathering + criteria co-creation
...
- [ ] Build evaluation engine — scoring + improvement plan generation
- [ ] Define rubric YAML schema — format for storing/sharing rubrics as skills
- [ ] Build first rubric skill: shit-commercial-development (test case: VoicesIQ V2 commercial)

## Medium Priority
- [ ] Build orchestrator agent (/shit-loop) — sequences research → interview → evaluate
- [ ] Build rubric skill template — boilerplate for creating new rubric skills quickly
